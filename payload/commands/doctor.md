...
After the report, ask the user exactly once: "Check for tool updates? This asks
Homebrew and npm and can take up to 30 seconds." (The script prints no question
of its own when it is not running in a terminal.) If they say yes, run:
