...
expect_eq "S19.3 …declared by 42 anchor calls (Section 8's doctoring rewrites two sentences; Section 12 adds three, K1; Section 6 adds three, K3; Section 13 adds three, K5; Section 15 adds two, K4; Section 16 adds one, K5.4; Section 17 adds two, wave-11 1c; Section 18 adds one, the oversized-core mutant; Section 24 adds one, wave-13 T3's repair-rule mutant; Section 27 adds one, wave-14 T10's rule-line mutant; wave-14 T28 rewrites one in place, no net change; wave-14 T33 adds one, DOCTORED_PATROL_T28's own anchor; wave-14 T36 adds one, the nudged-card-row discriminator)" "43" \
...
#
# 74 at epic-23 wave-14-tune-181 (2026-09-15, T36): 43 + 27 + 1 + 3, the docs-pins term
# alone moving again — T36's `DOCTORED_CARD_ROW` anchor, the row above this one. The other
# three terms are unmoved and were re-measured, not assumed: T36's Files: are card.sh,
# width.sh, the three templates and their finals, docs-pins and the two suites that wall
# the renderer, and none of them adds or removes an `anchor` call anywhere else.
#
...
expect_eq "S19.3 …74 anchor call sites across the four doctoring suites, all told" "74" \
