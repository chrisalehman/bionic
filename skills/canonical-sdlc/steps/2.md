...
Decision row: `    %-4s %-44s %-14s %s` (id, decision, serves, ADR) (printf).
Ownership row: `    %-12s owner %-14s surfaces %-22s test %s` (concept, owner, surfaces, test) (printf).
Eval-design row: `    %-8s %-36s %6s %5s %9s %5s %6s` (requirement, approach, static, unit, hermetic, live, human) (printf).
