...
| **Hooks** | Global: protect-main, protect-database, plus agent-context-guard wrappers for depth coverage. Armed-session only (registered by the canonical-sdlc skill on invocation): farm-out-reminder, canonical-sdlc-evidence-gate, canonical-sdlc-governing-skill, context-spend, and the landing/supervision fleet |
